...
<Prerequisites>
  ...
  <Prerequisite href="/guides/getting-started/quick-start">Complete your first project</Prerequisite>
</Prerequisites>
...
Target: .env.example (action: Add)
  ...
  · FEATURE_BETA = YOUR_VALUE_HERE

! Remember to replace placeholders with real values
