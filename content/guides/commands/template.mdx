...
tags: ["template", "reference", "cli", "config", "env"]
evnxVersion: "0.2.1"
prerequisites:
...
<Callout type="success">
  <strong>Pro tip:</strong> Store your template files with a <code>.template</code> or <code>.tpl</code> extension and add them to version control. Keep <code>.env*</code> files in <code>.gitignore</code>. This separates configuration structure from sensitive values.
</Callout>
