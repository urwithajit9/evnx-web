...
<Prerequisites>
  ...
  <Prerequisite href="/guides/reference/concepts-migrate-intro">Understand the migration pipeline</Prerequisite>
</Prerequisites>
...
- [Migration concepts](/guides/reference/concepts-migrate-intro) — pipeline, filtering, transforms
- [GitHub Actions migration](/guides/use-cases/use-cases-github-actions)
- [AWS Secrets Manager migration](/guides/use-cases/use-cases-aws)
- [GCP Secret Manager migration](/guides/use-cases/use-cases-gcp)