...
- [CI/CD Integration](/guides/integrations/ci-cd-sync) — Integrating template generation into automated pipelines
- [Security Best Practices](/guides/use-cases/prevent-secret-leaks) — Gitignore patterns and secrets manager integration