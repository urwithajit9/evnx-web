...
- [Convert basics](/guides/getting-started/convert-basic) — Step-by-step examples
- [Kubernetes integration](/guides/commands/convert)
- [Terraform workflow](/guides/commands/convert)
- [CI/CD automation](/guides/integrations/ci-cd-sync)