...
evnx v0.2.0 is live. It handles scanning, validation, format conversion, `.env.example` sync, cloud migration, encrypted backups, and a new `add` command for managing variables without touching the file directly.
</Callout>
