    ...
    <div>
      ...
      <section className="section-padding">
        <div className="container-base">
          {/* Featured Post */}
          <div className="mb-16 bg-bg-surface border border-border-muted rounded-lg overflow-hidden hover:border-border-default transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {recentPosts.map((post, idx) => (
              <div
                key={idx}
                className="bg-bg-surface border border-border-muted rounded-lg p-6 hover:border-border-default hover:bg-bg-overlay transition-all"
              >
